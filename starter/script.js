...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === 'walking') {
            ...
            workout = new Walking([lat, lng], distance, duration, cadance)
        }
    ...
    _renderWorkoutMarker(workout) {
        L.marker(workout.coords)
            ...
            ${workout.type === 'running' ? '🏃‍♂️' :
                    (workout.type === 'walking' ? '🚶‍♀️' :
                        (workout.type === 'hiking' ? '🥾' :
                            '🚴‍♀️'))}</span> ${workout.description}`)
            .openPopup();
    }
...
`;
        if (workout.type === 'running' || workout.type === 'walking' || workout.type === 'hiking')
